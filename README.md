# Sistema-Controle-Temperatura-Veicular

## :clipboard: Introdução

 Trabalho relacionado com as disciplinas de Sistemas Embarcados e Lógica Reconfigurável do curso de Engenharia de Computação da UTFPR-Curitiba, que consiste em simular um sistema de controle de temperatura veicular. O projeto foi desenvolvido pelos alunos João Victor Laskoski e Luis Camilo Jussiani Moreira.
